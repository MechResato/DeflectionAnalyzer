...
///     Changes: In and output parameters are now float
#include <stdint.h>
...
//
//----------------------------------------------------
uint8_t polyfit(const float* const 	dependentValues,
			...
			float*			 	coefficients)
{
	...
	for (ii = 0; ii < countOfElements; ii++){
		x	= (float)dependentValues[ii];
		y	= (float)independentValues[ii];
		powx = 1;
